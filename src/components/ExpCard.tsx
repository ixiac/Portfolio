  ...
  return (
    <div className="relative group">
      <div
       ...
       rounded-full transition duration-300 bg-muted-foreground">
        {" "}
      </div>

      <span className="text-neutral-300 lining-nums group-hover:text-emerald-600 transition duration-300">
        {item.year}
      </span>
